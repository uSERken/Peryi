...
//            NSLog(@"if,tempView:%@",NSStringFromCGRect(tempView.frame));
//            
//        } else if (scrollViewStartContentOffsetX > contentOffsetX) {
//            UIView *tempView = (UIView *)[self.contentViews firstObject];
//            tempView.frame = (CGRect){{0,0},scrollView.frame.size};
//             NSLog(@"else,tempView:%@",NSStringFromCGRect(tempView.frame));
//        }
//    }
//    
...
- (void)animationTimerDidFired:(NSTimer *)timer
{
    ...
    CGPoint newOffset = CGPointMake(pX + width, 0);
